...
- `GET/POST/PUT/DELETE /scheduled-messages`
- `GET/POST/DELETE /video-messages`
...
- `POST/DELETE /digital-key/trusted-persons`
- `POST /digital-key/trusted-persons/{id}/request`
...
信頼者が解除キーURLを使って開錠申請を送るページ（ログイン不要・公開）。
