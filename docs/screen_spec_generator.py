...
SCREENS = [
    ...
    ("estate", "相続の棚卸し", [
        ...
        ("S16: デジタル遺品鍵", "信頼者（受取人）を最大3名登録し、解除キーURLを発行する画面。死後に信頼者がURLにアクセスすることで開錠申請ができる。", [
            ("初期表示（信頼者未登録）", "s16a_digital_key_empty.png"),
            ("信頼者1名追加後", "s16b_digital_key_added.png"),
            ("解除キーURL表示", "s16c_digital_key_token.png"),
        ], ["URL: /digital-key", "信頼者最大3名", "開錠条件: 1名申請 or 2名申請", "解除キーURL コピーボタン付き"]),

        ("S17: リマインダー設定", "年次見直しリマインダーや未完了タスク通知のメール設定画面。", [
            ("初期表示（通知ON）", "s17a_reminder_on.png"),
            ("年次見直し月を変更", "s17b_reminder_month.png"),
            ("通知OFF状態", "s17c_reminder_off.png"),
        ], ["URL: /settings/reminders", "通知ON/OFFトグル", "年次見直し月選択（1〜12月）", "通知先メールアドレス設定"]),

        ("S18: エンディングノート — 追悼メッセージタブ", "エンディングノートの追悼メッセージタブ。死後に家族に送る予約メッセージを作成・管理する。", [
            ("メッセージ一覧（空）", "s18a_scheduled_msg_empty.png"),
            ("メッセージ作成フォーム", "s18b_scheduled_msg_form.png"),
            ("メッセージ作成後", "s18c_scheduled_msg_created.png"),
        ], ["URL: /ending-note（追悼メッセージタブ）", "宛先名・宛先メール・件名・本文の入力", "作成済みメッセージの編集・削除"]),

        ("S19: エンディングノート — ビデオメッセージタブ", "エンディングノートのビデオメッセージタブ。動画ファイルをアップロードして保管する。", [
            ("初期表示（動画なし）", "s19a_video_empty.png"),
            ("アップロードフォーム表示", "s19b_video_form.png"),
        ], ["URL: /ending-note（ビデオメッセージタブ）", "動画ファイルアップロード（video/*）", "タイトル・説明の入力"]),

        ("S20: 遺言書シミュレーター — テキストプレビュー・法的案内", "WillSimulatorの遺言書テキストプレビューと自筆証書遺言の法的要件案内。", [
            ("テキストプレビュー展開", "s20a_will_preview.png"),
            ("法的手続き案内", "s20b_will_legal.png"),
        ], ["URL: /estate/:planId/will", "テキストプレビューボタンで遺言書文書をリアルタイム表示", "自筆証書遺言の4要件・法務局保管・公証役場案内"]),
